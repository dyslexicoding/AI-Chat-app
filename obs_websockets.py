...
from obs_websockets_auth import WEBSOCKET_HOST, WEBSOCKET_PORT, WEBSOCKET_PASSWORD
...
if __name__ == '__main__':
    ...
    # transform = obswebsockets_manager.get_source_transform('live', "Middle Monitor")
    # print(f"Here's the transform: {transform}\n\n")

    # print("Setting a source's transform!")
    # new_transform = {"scaleX": 2, "scaleY": 2}
    # obswebsockets_manager.set_source_transform('live', "Middle Monitor", new_transform)
    # time.sleep(3)
    # print("Setting the transform back. \n\n")
    # obswebsockets_manager.set_source_transform('live', "Middle Monitor", transform)
